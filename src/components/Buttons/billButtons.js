            ...
            <div class = "billCtaDiv">
                {
                    ...
                    <div class="billCta">
                        {
                            params.tableStatus[0]=="BillPrinted"?<DisabledButton text="Print Bill"></DisabledButton>:<ActiveButton text="Print Bill" clickFunc = "printBill" currentOrder = {params.currentOrder} bill= {params.bill}></ActiveButton>
                        }
                        {
